...
if direction == "left":
    ...
    if wait_or_swim == "wait":
        ...
        if door == "red":
            ...
            print("It's a room full of beasts.\nGame Over.")
        elif door == "yellow":
            print("You found the treasure. You win!")
        else:
            print("You chose a door that doesn't exist. Game Over.")
    else:
        print("You start swimming, but you remember that you don't know how to swim.\n"
              "Game Over, you've drown.")
else:
    print("Oh no, you noclipped trough the floor and... You entered The Backrooms.\n"
          "Game Over, for now...")
